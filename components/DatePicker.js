...
export default function DatePicker({ close, checkInDate, checkOutDate, numberOfAdults, numberOfChildren }) {
      ...
      <div className="inner">
        ...
        <div className="guests">
          ...
          <div className="inputs">
            <NumberInput name="Adults" value={numberOfAdults.value} setValue={numberOfAdults.setValue}/>
            <NumberInput name="Children" value={numberOfChildren.value} setValue={numberOfChildren.setValue}/>
          </div>
        </div>
